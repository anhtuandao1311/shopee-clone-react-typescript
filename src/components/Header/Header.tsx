      ...
      <div className='container'>
          ...
          {isAuthenticated && (
            ...
            >
              <div className='w-6 h-6 mr-2'>
                <img
                  src='https://cdn.icon-icons.com/icons2/4076/PNG/512/people_emotface_happiness_smiley_emoji_smile_happy_icon_258939.png'
                  alt='avatar'
        ...
        <div className='grid grid-cols-12 gap-4 mt-4 items-end'>
          <Link to={path.home} className='col-span-2'>
            <svg viewBox='0 0 192 65' className='w-full fill-white'>
              <g fillRule='evenodd'>
          ...
          <div className='col-span-1'>
            ...
            >
              <Link to={path.cart} className='text-white relative'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'

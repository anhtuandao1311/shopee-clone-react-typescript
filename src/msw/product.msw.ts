    ...
    products: [
      {
        ...
        updatedAt: '2024-01-31T17:24:57.125Z'
      },
      {
      ...
      },
      {
        ...
        updatedAt: '2024-01-25T02:28:07.688Z'
      },
      {
        ...
        updatedAt: '2024-02-01T14:08:05.645Z'
      },
      {
        ...
        updatedAt: '2024-01-26T15:57:37.586Z'
      },
      {
...
const getProductsRequest = http.get(`${config.baseUrl}products`, () => {
  return HttpResponse.json(getProductsResponse, {
    status: HttpStatusCode.Ok
  })
})

const productRequests = [getProductsRequest]
